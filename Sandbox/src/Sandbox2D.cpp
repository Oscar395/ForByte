...
void Sandbox2D::OnUpdate(ForByte::Timestep ts)
{
...

	{
		...
		ForByte::Renderer2D::DrawRotatedQuad({ 1.0f, 0.0f }, { 0.8f, 0.8f }, -45.0f, {0.8f, 0.2f, 0.3f, 1.0f});
		...
		ForByte::Renderer2D::DrawQuad({ 0.0f, 0.0f , -0.1f }, { 10.0f, 10.0f }, m_CheckerboardTexture, 1.0f, glm::vec4(1.0f, 0.9f, 0.9f, 1.0f));
		ForByte::Renderer2D::DrawRotatedQuad({ -2.0f, 0.0f , 0.0f }, { 1.0f, 1.0f }, rotation, m_CheckerboardTexture, 20.0f, glm::vec4(1.0f, 0.9f, 0.9f, 1.0f));
